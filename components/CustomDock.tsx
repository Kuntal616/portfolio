...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/Kuntal616",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/kuntal-sadhukhan-068aa4243/",
        icon: Icons.linkedin,
      },
      X: {
        name: "X",
        url: "https://x.com/KuntalSadhukh10",
        icon: Icons.x,
      },
      email: {
        name: "Send Email",
        url: "mailto:kuntalsadhukhan175@gmail.com",
        icon: Icons.email,
      },
    },
  },
...
export default function CustomDock({
  ...
  return (
    <div
      className={
        isMobile
          ? " fixed left-1/2 right-1/2 flex items-center justify-center bottom-5"
          : " fixed left-40 flex items-center justify-center top-1/2 bottom-1/2"
      }
    >
      {mounted && (
        <TooltipProvider>
